    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
            <div className="bg-[--bg-secondary] text-[--text-primary] rounded-lg shadow-xl p-6 w-full max-w-sm">
                ...
                <p className="text-[--text-secondary] mb-6">¿Estás seguro de que quieres borrar todo? Esta acción eliminará todas las capas y no se puede deshacer de forma convencional (aunque sí con el botón Deshacer).</p>
